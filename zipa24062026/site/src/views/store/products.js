                                ...
                                <div className="profile">
                                    ...
                                    <div className="products-wrap">
                                        <div className="top">
                                            ...
                                            <div>
                                                <Link to='/'>
                                                    <button className="button">Dodaj artikal</button>

                                                </Link>
                                                <div className="search-wrap">
                                                    <div>
                                                        <Isvg src={search} />
                                                        <input type="text" placeholder="Pretraži proizvode" onChange={(e) => { this.setState({ shopSearch: e.target.value }) }} value={this.state.shopSearch} onKeyUp={(e) => {
                                                            if (e.keyCode === 13) {
                                        ...
                                        <div className="table">
                                            <div>
                                                <table>
                                                    ...
                                                    {
                                                        this.state.products && this.state.products.length && this.state.products.map((item, idx) => {
                                                            return (
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <button onClick={() => this.props.handleDelete(() => {
                                                                            fetch(`${API_ENDPOINT}/products/delete/store/${this.props[0].match.params.storeAlias}/${item._id}`, {
                                                                                method: 'DELETE',
                                                                                headers: {
