    ...
    render() {
        ...
        return (
            <AdminOkvir
                ...
                naslov={'Logovi'.translate(this.props.lang)}
            >
                        ...
                        <Row>
                            <Col lg="12" className="page-top-wrapper">
                                ...
                                <ul>
                                    ...
                                    <li><Link>{'Logovi'.translate(this.props.lang)}</Link></li>
                                </ul>
                                    ...
                                    <div>
                                        <table>
                                            <tr>
                                                ...
                                                <th>{'URL'.translate(this.props.lang)}</th>
                                                <th>{'Datum'.translate(this.props.lang)}</th>
                                            </tr>
