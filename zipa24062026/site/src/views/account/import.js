...
import CategoryForm from '../../components/forms/importForm';
...
class CategoryPage extends Component {
    ...
    submit(data) {
        console.log(data);
        fetch(`${API_ENDPOINT}/newsletter/import`, {
            method: 'POST',
            headers: {
            ...
            if (result.error) {
                ...
                this.props[0].history.push('/account/subscribers')
            }
        })
    ...
    render() {
        return (
            <AdminOkvir
                ...
                naslov={'Uvoz pretplatnika'.translate(this.props.lang)}
                radnja={<Link to="/account/subscribers" className="z-adminokvir__radnja z-adminokvir__radnja--tiha">{'Nazad na spisak'.translate(this.props.lang)}</Link>}
            >
