    ...
    render() {
        return (
            <AdminOkvir
                ...
                naslov={'Slajd'.translate(this.props.lang)}
                radnja={<Link to="/account/slides" className="z-adminokvir__radnja z-adminokvir__radnja--tiha">{'Nazad na spisak'.translate(this.props.lang)}</Link>}
            >
