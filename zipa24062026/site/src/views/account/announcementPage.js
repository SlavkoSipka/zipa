    ...
    render() {
        return (
            <AdminOkvir
                ...
                naslov={'Najava'.translate(this.props.lang)}
                radnja={<Link to="/account/announcements" className="z-adminokvir__radnja z-adminokvir__radnja--tiha">{'Nazad na spisak'.translate(this.props.lang)}</Link>}
            >
