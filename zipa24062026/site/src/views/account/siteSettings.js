...
import CategoryForm from '../../components/forms/settingsForm';
    ...
    render() {
        return (
            <AdminOkvir
                ...
                naslov={'Podešavanja'.translate(this.props.lang)}
            >
