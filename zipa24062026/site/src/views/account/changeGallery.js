    ...
    render() {
        ...
        return (
            <Okvir
                ...
                naslov={'Galerija'.translate(this.props.lang)}
                radnja={<Link to="/account/galleries" className="z-adminokvir__radnja z-adminokvir__radnja--tiha">{'Nazad na spisak'.translate(this.props.lang)}</Link>}
            >
